    ...
    },
    {
        ...
        topics: [
            ...
            },
            {
                ...
                chapters: [
                    {
                        id: "1", title: "凸集合", description: "定義・性質・射影・分離定理・サポート関数",
                        sections: [
                            { id: "1.1", title: "凸集合の定義と例", description: "線分条件による定義、半空間・球・多面体・錐などの例" },
                            { id: "1.2", title: "凸包と凸錐", description: "凸包の定義と最小性、凸錐の定義と極錐の概念" },
                    ...
                    {
                        id: "2", title: "凸関数", description: "定義・特徴づけ・下半連続性・真の凸関数・指示関数",
                        sections: [
                            ...
                            { id: "2.4", title: "指示関数と制約の凸解析的表現", description: "凸集合 C の指示関数 δ_C の定義、制約付き最適化の無制約問題への帰着、サポート関数が指示関数の共役であることの確認" },
                            { id: "2.5", title: "凸関数の連続性と微分可能性", description: "内点での連続性定理、局所リプシッツ性、方向微分の存在と凸性の関係、ラデマッハーの定理による概微分可能性" },
                            { id: "2.6", title: "強凸関数", description: "強凸性の定義、最小値の存在・一意性への応用" }
                        ]
                    },
                    {
                        id: "3", title: "劣微分", description: "劣勾配・劣微分の定義・計算規則・制約想定・最適性条件",
                        sections: [
                            { id: "3.1", title: "劣勾配と劣微分の定義", description: "微分不可能点での接超平面の一般化、劣微分集合の凸・コンパクト性" },
                            { id: "3.2", title: "劣微分の計算例", description: "絶対値関数・ノルム・最大値関数・指示関数の劣微分の計算" },
                            { id: "3.3", title: "劣微分の和の公式と制約想定", description: "和の公式 ∂(f+g) ⊇ ∂f + ∂g の一般的な包含関係、相対的内部の交差条件 ri(dom f) ∩ ri(dom g) ≠ ∅ による等号成立の証明" },
                            { id: "3.4", title: "劣微分の合成則", description: "アフィン写像との合成の劣微分、スカラー倍の公式、一般の合成に対する連鎖律の制約想定" },
                            { id: "3.5", title: "最適性条件", description: "無制約最小化問題における 0 ∈ ∂f の条件、指示関数を用いた制約付き問題への応用" }
                        ]
                    },
                    {
                        id: "4", title: "共役関数（フェンシェル共役）", description: "定義・ヤング-フェンシェルの不等式・例・双共役・フェンシェル-モロの定理・インフィマル畳み込み",
                        sections: [
                            { id: "4.1", title: "共役関数の定義とヤング-フェンシェルの不等式", description: "ルジャンドル-フェンシェル変換による定義と幾何的意味、ヤング-フェンシェルの不等式と等号条件、劣微分との対応" },
                            { id: "4.2", title: "共役関数の計算例", description: "二次関数・指数関数・ノルム・指示関数の共役関数の計算、指示関数とサポート関数の双対関係の確認" },
                            { id: "4.3", title: "双共役と下半連続凸包", description: "双共役が閉じた凸関数の最大の下界となることの証明" },
                            { id: "4.4", title: "フェンシェル-モロの定理", description: "閉真凸関数が双共役に一致することの証明" },
                            { id: "4.5", title: "インフィマル畳み込み", description: "f □ g の定義、共役関数の和との双対関係 (f □ g)* = f* + g* の証明、モロー包絡への接続" }
                        ]
                    },
                    {
                        id: "5", title: "フェンシェル双対性", description: "主問題と双対問題・双対ギャップ・強双対定理・KKT条件",
                        sections: [
                            { id: "5.1", title: "主問題と双対問題の設定", description: "フェンシェル双対問題の定式化と弱双対定理" },
                            { id: "5.2", title: "強双対定理とスレーターの条件", description: "双対ギャップが零になるための制約想定の条件、相対的内部条件による証明" },
                            { id: "5.3", title: "ラグランジュ双対性との関係", description: "ラグランジュ乗数法とフェンシェル双対の統一的な見方、最適化理論（A-3）との棲み分け" },
                            { id: "5.4", title: "KKT条件", description: "鞍点条件・相補スラック性・最適性の一階条件の導出" },
                            { id: "5.5", title: "ミニマックス定理と鞍点", description: "鞍点と max-min = min-max の一致条件、フォン・ノイマンのミニマックス定理のフェンシェル双対性からの導出、シオンのミニマックス定理への一般化" }
                        ]
                    },
                    {
                        id: "6", title: "単調作用素と凸解析", description: "単調作用素・劣微分の単調性・極大単調性・ミンティの定理",
                        sections: [
                            { id: "6.1", title: "単調作用素の定義と例", description: "単調作用素・狭義単調作用素の定義、勾配写像・劣微分の例" },
                            { id: "6.2", title: "劣微分の極大単調性", description: "閉真凸関数の劣微分が極大単調作用素であることの証明" },
                            { id: "6.3", title: "ミンティの定理", description: "極大単調作用素の値域条件と解の存在定理" },
                            { id: "6.4", title: "単調作用素の零点問題と最適化", description: "0 ∈ T(x) の形の問題と凸最適化の接続、関数解析（4-1）への展望" }
                        ]
                    },
                    {
                        id: "7", title: "近接作用素と凸最適化アルゴリズム", description: "近接作用素・モロー包絡・劣勾配法・近接点法・分割法・ADMM",
                        sections: [
                            { id: "7.1", title: "近接作用素の定義と性質", description: "モロー包絡とインフィマル畳み込みの関係、近接作用素の定義、非拡大性の証明" },
                            { id: "7.2", title: "モローの分解定理", description: "近接作用素と共役関数の近接作用素の和による分解、射影との関係" },
                            { id: "7.3", title: "近接作用素の計算例", description: "L1ノルム・指示関数（= 射影）・二次関数の近接作用素の具体計算" },
                            { id: "7.4", title: "劣勾配法", description: "非平滑凸最適化への勾配法の拡張、ステップサイズの選択と収束速度の評価" },
                            { id: "7.5", title: "近接点法と前向き後向き分割", description: "和の構造を持つ凸問題への分割アルゴリズム、ダグラス-ラクフォード分割法" },
                            { id: "7.6", title: "ADMM（交互方向乗数法）", description: "制約付き問題への分散的アルゴリズムの構成と収束性、ダグラス-ラクフォード法との関係" }
                        ]
                    }
                ],
                ...
                chapters: [
                    {
                        ...
                        sections: [
                            ...
                            { id: "1.5", title: "1の分割の存在定理", description: "パラコンパクト性を用いた滑らかな1の分割の構成、大域的構成への応用の概観" }
                        ]
                    },
                    {
                        id: "2", title: "多様体上の写像と部分多様体", description: "滑らかな写像・微分同相・逆関数定理・ランク定理・はめ込み・埋め込み・正則値定理",
                        sections: [
                            { id: "2.1", title: "滑らかな写像と微分同相", description: "チャートを介した滑らかさの定義、微分同相の例" },
                            { id: "2.2", title: "逆関数定理の多様体版", description: "微分が同型ならば局所微分同相であること、逆写像定理の拡張" },
                            { id: "2.3", title: "写像の微分とランク定理", description: "接空間の間の線形写像としての微分、定ランク定理" },
                            { id: "2.4", title: "はめ込みと埋め込み", description: "定義と違い、部分多様体としての像の条件" },
                            { id: "2.5", title: "正則値定理", description: "正則値の定義、逆像が部分多様体になるための条件と証明、陰関数定理の多様体版としての位置づけ" }
                        ]
                    },
                    {
                        id: "3", title: "接空間と接束", description: "接ベクトルの定義・接写像・ベクトル束・接束・ベクトル場・フロー・リー括弧積",
                        sections: [
                            { id: "3.1", title: "接空間の定義", description: "曲線の速度ベクトルによる定義と導分による定義の同値性" },
                            { id: "3.2", title: "接写像", description: "写像の微分の接空間による定式化、連鎖律との対応" },
                            { id: "3.3", title: "ベクトル束の定義", description: "ベクトル束の一般的な定義、局所自明性と遷移関数、切断の概念" },
                            { id: "3.4", title: "接束とベクトル場", description: "接束 TM のベクトル束構造の確認、滑らかなベクトル場の定義" },
                            { id: "3.5", title: "ベクトル場のフローと積分曲線", description: "積分曲線の存在と一意性定理、1パラメータ変換群としてのフローの定義、完備ベクトル場" },
                            { id: "3.6", title: "リー括弧積", description: "ベクトル場の交換子の定義、ヤコビ恒等式、フローの交換可能性との関係" }
                        ]
                    },
                    {
                        id: "4", title: "余接空間とテンソル場", description: "余接束・1-形式・テンソル場・リー微分",
                        sections: [
                            { id: "4.1", title: "余接空間と余接束", description: "接空間の双対としての余接空間、余接束 T*M のベクトル束構造、双対空間の多様体版としての位置づけ" },
                            { id: "4.2", title: "関数の微分と1-形式", description: "df の定義、座標基底による表示、滑らかな1-形式" },
                            { id: "4.3", title: "テンソル場", description: "テンソル積を用いた反変・共変・混合テンソル束の定義と例" },
                            { id: "4.4", title: "リー微分", description: "ベクトル場のフロー（§3.5）によるテンソル場の微分、カルタンの公式、ベクトル場との交換関係" }
                        ]
                    },
                    {
                        id: "5", title: "微分形式と外微分", description: "k-形式・ウェッジ積・外微分・引き戻し・内部積",
                        sections: [
                            { id: "5.1", title: "微分形式の定義", description: "外積代数を用いた交代テンソル場としての k-形式、局所座標による表示" },
                    ...
                    {
                        id: "6", title: "向き付けと多様体上の積分", description: "向き付け・体積形式・積分・境界付き多様体・ストークスの定理",
                        sections: [
                            { id: "6.1", title: "向き付けの定義", description: "アトラスの整合性による向き付けの定義、向き付け不可能な例としてメビウスの帯" },
                            { id: "6.2", title: "体積形式", description: "向き付け可能な多様体上の体積形式の存在と局所座標表示" },
                            { id: "6.3", title: "コンパクト台をもつ形式の積分", description: "1の分割（§1.5）を用いた積分の定義と座標変換に関する整合性の証明" },
                            { id: "6.4", title: "境界付き多様体", description: "上半空間をモデルとする境界付き多様体の定義、境界の誘導される向き付け" },
                            { id: "6.5", title: "ストークスの定理", description: "一般ストークスの定理の証明、グリーン・ガウス・ストークスの古典的定理の統一としての位置づけ" }
                        ]
                    },
                    {
                        id: "7", title: "ド・ラームコホモロジー", description: "閉形式・完全形式・ポアンカレの補題・マイヤー・ビエトリス完全系列・ド・ラームの定理",
                        sections: [
                            { id: "7.1", title: "ド・ラームコホモロジーの定義", description: "閉形式と完全形式の差を測る商空間としての定義、関手的性質" },
                            { id: "7.2", title: "ポアンカレの補題", description: "可縮な多様体上でのすべての閉形式の完全性の証明、ホモトピー作用素の構成" },
                            { id: "7.3", title: "マイヤー・ビエトリス完全系列", description: "開被覆に関するド・ラームコホモロジーの長完全系列の構成と証明" },
                            { id: "7.4", title: "ド・ラームコホモロジーの計算例", description: "マイヤー・ビエトリス完全系列を用いた球面・トーラス・実射影空間の具体的計算" },
                            { id: "7.5", title: "ド・ラームの定理", description: "特異コホモロジーとの同型定理の主張と意義、代数的トポロジー（4-8）との接続" }
                        ]
                    }
                ],
            ...
            },
            {
                ...
                chapters: [
                    {
                        id: "1", title: "リーマン計量と等長変換", description: "計量テンソル・距離・体積形式・キリング場・等長変換群",
                        sections: [
                            ...
                            { id: "1.4", title: "キリング場と等長変換群", description: "キリング方程式、等長変換群のリー代数との対応、定曲率空間の等長変換群" }
                        ]
                    },
                    {
                    ...
                    {
                        id: "4", title: "曲率テンソル", description: "リーマン曲率テンソル・断面曲率・リッチ曲率・スカラー曲率・ヤコビ場",
                        sections: [
                            ...
                            { id: "4.4", title: "ヤコビ場と共役点", description: "ヤコビ方程式の導出、共役点の定義、定曲率空間でのヤコビ場の明示解" }
                        ]
                    },
                    {
                        id: "5", title: "比較幾何学と大域的結果", description: "ラウフの比較定理・トポノゴフの比較定理・体積比較・マイヤースの定理",
                        sections: [
                            { id: "5.1", title: "ラウフの比較定理", description: "ヤコビ場のノルムの比較、断面曲率の上下界による測地線の広がりの評価" },
                            { id: "5.2", title: "トポノゴフの比較定理", description: "測地三角形の辺と角の比較、定曲率空間との対比" },
                            { id: "5.3", title: "ビショップ-グロモフの体積比較定理", description: "測地球の体積比の単調性、リッチ曲率による体積の上界" },
                            { id: "5.4", title: "マイヤースの定理とシンジの定理", description: "正のリッチ曲率による直径の有界性と基本群の有限性、偶数次元正曲率多様体の単連結性" }
                        ]
                    },
                    {
                        id: "6", title: "部分多様体とガウス-ボンネの定理", description: "リーマン部分多様体・第二基本形式・ガウス方程式・ガウス-ボンネの定理",
                        sections: [
                            { id: "6.1", title: "リーマン部分多様体と誘導計量", description: "等長はめ込みの定義、誘導計量と法束の構成" },
                            { id: "6.2", title: "第二基本形式とガウス・コダッチ方程式", description: "形状作用素と第二基本形式、ガウス方程式・コダッチ-マイナルディ方程式" },
                            { id: "6.3", title: "超曲面のガウス曲率とガウスの驚くべき定理", description: "主曲率・ガウス曲率・平均曲率の定義、ガウス曲率が等長不変量であることの証明" },
                            { id: "6.4", title: "ガウス-ボンネの定理", description: "コンパクト向き付け可能曲面での全曲率とオイラー標数の関係の証明" }
                        ]
                    },
                    {
                        id: "7", title: "ファイバー束と接続", description: "ベクトル束・主束・構造群・接続形式・曲率形式・ホロノミー",
                        sections: [
                            { id: "7.1", title: "ベクトル束の定義と例", description: "接束・余接束・テンソル束のベクトル束としての統一的定義" },
                            { id: "7.2", title: "主ファイバー束", description: "構造群をもつ束の定義、フレーム束との関係" },
                            { id: "7.3", title: "主束上の接続", description: "水平分布による接続の定義、接続形式と曲率形式" },
                            { id: "7.4", title: "ホロノミー群", description: "平行移動の経路依存性、ホロノミー群の定義とアンビローズ-シンガーの定理" }
                        ]
                    },
                    {
                        id: "8", title: "特性類", description: "チャーン類・ポントリャーギン類・オイラー類・チャーン-ウェイユ理論",
                        sections: [
                            { id: "8.1", title: "特性類の概念と動機", description: "ベクトル束のトポロジー的不変量としての特性類の意義" },
                            { id: "8.2", title: "チャーン-ウェイユ理論", description: "曲率形式による特性類の構成、接続によらない不変性の証明" },
                            { id: "8.3", title: "チャーン類とポントリャーギン類", description: "複素・実ベクトル束に対する各特性類の定義と計算例" },
                            { id: "8.4", title: "オイラー類とガウス-ボンネ-チャーンの定理", description: "オイラー類によるガウス-ボンネ定理の高次元化" }
                        ]
                    },
                    {
                        id: "9", title: "指数定理への展望", description: "楕円型作用素の概念・解析的指数と位相的指数・応用の概観",
                        sections: [
                            { id: "9.1", title: "楕円型微分作用素の概念", description: "主表象と楕円型条件の定義、ラプラシアン・ディラック作用素の例" },
                            { id: "9.2", title: "解析的指数と位相的指数", description: "核と余核の有限次元性の主張、指数の定義の概説" },
                            { id: "9.3", title: "アティヤ-シンガーの指数定理の主張", description: "解析的指数と特性類による位相的指数の一致、定理の意味の解説" },
                            { id: "9.4", title: "特別な場合への応用", description: "ガウス-ボンネ-チャーン・リーマン-ロッホ・ハーゼブルーフ署名定理の統一的理解" }
                        ]
                    }
                ],
                prerequisites: ["4-5"]
        ...
        topics: [
            {
                ...
                chapters: [
                    {
                        id: "1", title: "基本概念", description: "グラフの定義・頂点と辺・次数・同型・補グラフ・道と閉路・連結性",
                        sections: [
                            { id: "1.1", title: "グラフの定義と種類", description: "無向グラフ・有向グラフ・多重グラフ・単純グラフの定義、隣接行列・接続行列による表現" },
                            { id: "1.2", title: "グラフの同型と自己同型", description: "グラフの同型の定義、同型判定の基本的な不変量（頂点数・辺数・次数列）、自己同型群の定義と例" },
                            { id: "1.3", title: "補グラフと基本的なグラフ演算", description: "補グラフ・部分グラフ・誘導部分グラフの定義、グラフの和・直積の定義と例" },
                            { id: "1.4", title: "次数と握手補題", description: "頂点の次数の定義、全頂点の次数の和が辺数の2倍であることの証明" },
                            { id: "1.5", title: "道・歩道・閉路", description: "歩道・道・閉路の定義の区別、長さの定義、最短路の概念" },
                            { id: "1.6", title: "連結性と連結成分", description: "連結グラフの定義、連結成分の定義と個数、橋と切断点の定義" },
                            { id: "1.7", title: "二部グラフの特徴づけ", description: "二部グラフの定義、奇閉路を含まないことへの同値性の証明" }
                        ]
                    },
                    {
                        id: "2", title: "有向グラフの基礎", description: "有向グラフの基本性質・強連結性・DAG・位相ソート",
                        sections: [
                            { id: "2.1", title: "有向グラフの基本概念", description: "有向辺・入次数・出次数の定義、有向グラフの握手補題（入次数の和 = 出次数の和 = 辺数）" },
                            { id: "2.2", title: "有向道と強連結性", description: "有向道・有向閉路の定義、強連結グラフの定義、強連結成分への分解" },
                            { id: "2.3", title: "有向非巡回グラフ（DAG）と位相ソート", description: "DAG の定義、位相ソートの存在と一意性の条件、DFS に基づく位相ソートアルゴリズム" },
                            { id: "2.4", title: "有向木と根付き木", description: "根付き木の定義、二分木・完全木の基本性質、探索木への応用の概観" }
                        ]
                    },
                    {
                        id: "3", title: "木", description: "木の定義と特徴づけ・全域木・最小全域木アルゴリズム",
                        sections: [
                            { id: "3.1", title: "木の定義と同値条件", description: "閉路を含まない連結グラフとしての定義、辺数・頂点数・連結性・非閉路性による複数の同値条件" },
                            { id: "3.2", title: "全域木の存在と構成", description: "連結グラフの全域木の存在定理、BFS・DFS による構成" },
                            { id: "3.3", title: "プリューファー符号と標識木の個数", description: "標識木の数え上げ、ケイリーの公式 n^{n-2} の証明" },
                            { id: "3.4", title: "最小全域木とクラスカル法", description: "重み付きグラフの最小全域木の定義、クラスカル法の正当性の証明" },
                            { id: "3.5", title: "プリム法とその計算量", description: "プリム法の手順と正当性、クラスカル法との比較" }
                        ]
                    },
                    {
                        id: "4", title: "オイラー路とハミルトン路", description: "オイラーグラフの判定・ハミルトン閉路・計算複雑性の違い",
                        sections: [
                            { id: "4.1", title: "オイラー路の定義と判定条件", description: "オイラー路・オイラー閉路の定義、奇数次頂点の個数による判定定理の証明" },
                            { id: "4.2", title: "フルーリーのアルゴリズム", description: "オイラー路の構成的アルゴリズム、橋を避ける選択の役割" },
                            { id: "4.3", title: "有向グラフのオイラー路", description: "有向オイラー閉路の条件、各頂点の入次数と出次数の一致" },
                            { id: "4.4", title: "ハミルトン閉路の定義と例", description: "ハミルトン路・閉路の定義、正十二面体グラフなどの例" },
                            { id: "4.5", title: "ディラックの定理とオーレの定理", description: "ハミルトン閉路の存在の十分条件の証明、オイラー路との計算複雑性の対比（多項式時間 vs NP 完全）" }
                        ]
                    },
                    {
                        id: "5", title: "平面グラフ", description: "平面埋め込み・オイラーの多面体公式・クラトフスキーの定理",
                        sections: [
                            { id: "5.1", title: "平面グラフの定義と平面埋め込み", description: "辺の交差なしの埋め込みの定義、面の定義" },
                            { id: "5.2", title: "オイラーの多面体公式", description: "連結平面グラフの V - E + F = 2 の証明、球面との位相的対応" },
                            { id: "5.3", title: "平面グラフの辺数の上界", description: "E ≤ 3V - 6 の証明、K_5・K_{3,3} の非平面性の導出" },
                            { id: "5.4", title: "クラトフスキーの定理", description: "グラフが平面的 ⟺ K_5・K_{3,3} の細分を含まないことの主張と証明の概略" },
                            { id: "5.5", title: "ワグナーの定理とマイナー", description: "マイナーの定義、グラフが平面的 ⟺ K_5・K_{3,3} をマイナーとして含まないことの主張" }
                        ]
                    },
                    {
                        id: "6", title: "グラフの彩色", description: "頂点彩色・彩色数・ブルックスの定理・辺彩色・四色定理",
                        sections: [
                            { id: "6.1", title: "頂点彩色と彩色数", description: "k-彩色の定義、彩色数 χ(G) の定義、二部グラフの彩色数が最大2であることの証明" },
                            { id: "6.2", title: "貪欲彩色とブルックスの定理", description: "貪欲彩色アルゴリズムによる上界 χ(G) ≤ Δ(G)+1、ブルックスの定理（完全グラフと奇閉路以外では χ(G) ≤ Δ(G)）の証明、クリーク数による下界 χ(G) ≥ ω(G)" },
                            { id: "6.3", title: "四色定理の主張", description: "平面グラフの彩色数が4以下であるという主張、五色定理の証明、コンピュータ証明の意義" },
                            { id: "6.4", title: "辺彩色とヴィジングの定理", description: "辺彩色数 χ'(G) の定義、χ'(G) = Δ(G) または Δ(G)+1 であるというヴィジングの定理、クラス1・クラス2の分類" },
                            { id: "6.5", title: "彩色多項式", description: "グラフの彩色多項式の定義、削除-縮約公式による計算、彩色多項式と彩色数の関係" }
                        ]
                    },
                    {
                        id: "7", title: "マッチングとカバー", description: "マッチング・ホール婚姻定理・チュッテの定理・最大マッチング・ケーニヒの定理",
                        sections: [
                            { id: "7.1", title: "マッチングの定義と完全マッチング", description: "マッチング・極大マッチング・最大マッチング・完全マッチングの定義" },
                            { id: "7.2", title: "ホール婚姻定理", description: "二部グラフに完全マッチングが存在するための必要十分条件（ホール条件）の証明" },
                            { id: "7.3", title: "増加路とベルゲの定理", description: "増加路の定義、マッチングが最大 ⟺ 増加路が存在しないことの証明" },
                            { id: "7.4", title: "ケーニヒの定理", description: "二部グラフの最大マッチングのサイズと最小頂点被覆のサイズの一致の証明" },
                            { id: "7.5", title: "チュッテの定理", description: "一般グラフの完全マッチングの存在条件（チュッテ-ベルゲの公式）の主張と証明の概略" },
                            { id: "7.6", title: "一般グラフの最大マッチングアルゴリズム", description: "エドモンズの開花アルゴリズムの概観、奇数サイクルの縮約操作" }
                        ]
                    },
                    {
                        id: "8", title: "ネットワークフロー", description: "フローネットワーク・最大流・最小カット・最大流最小カット定理・メンガーの定理",
                        sections: [
                            { id: "8.1", title: "フローネットワークの定義", description: "容量・フロー・源泉・吸収の定義、フローの保存則" },
                            { id: "8.2", title: "増加路とフォード-ファルカーソン法", description: "残余グラフ・増加路の定義、アルゴリズムの手順と終了条件" },
                            { id: "8.3", title: "最大流最小カット定理", description: "s-t カットの定義、最大フローの値と最小カットの容量の一致の証明" },
                            { id: "8.4", title: "エドモンズ-カープ法の計算量", description: "BFS による増加路探索、O(VE^2) の計算量解析" },
                            { id: "8.5", title: "メンガーの定理", description: "辺素な道・頂点素な道の最大本数とカットの最小サイズの一致、最大流最小カット定理の系としての導出" },
                            { id: "8.6", title: "最大流の応用", description: "二部マッチングの最大流への帰着、連結度の計算、プロジェクトスケジューリングへの応用" }
                        ]
                    },
                    {
                        id: "9", title: "代数的グラフ理論入門", description: "隣接行列のスペクトル・ラプラシアン行列・スペクトルによるグラフの性質の判定",
                        sections: [
                            { id: "9.1", title: "隣接行列の固有値", description: "隣接行列のスペクトルの定義、正則グラフのスペクトルの基本性質、スペクトルの計算例" },
                            { id: "9.2", title: "ラプラシアン行列", description: "グラフラプラシアン L = D - A の定義、L の固有値の非負性、第2最小固有値と連結性（フィードラーの定理）" },
                            { id: "9.3", title: "スペクトルによるグラフの性質", description: "二部グラフのスペクトルの対称性、独立数・彩色数のスペクトルによる評価（ホフマンの不等式）" },
                            { id: "9.4", title: "展望", description: "スペクトルクラスタリング・ランダムウォークとの接続、エクスパンダーグラフの概観、組合せ論（A-2）との接続" }
                        ]
                    }
                ],
                prerequisites: ["高校数学"]
