            ...
            },
            {
                ...
                chapters: [
                    ...
                    },
                    {
                        ...
                        sections: [
                            { id: "4.1", title: "余接空間と余接束", description: "接空間の双対としての余接空間、余接束 T*M のベクトル束構造、多重線形代数学I（3-11）の双対空間の多様体版としての位置づけ" },
                            { id: "4.2", title: "関数の微分と1-形式", description: "df の定義、座標基底による表示、滑らかな1-形式" },
                            { id: "4.3", title: "テンソル場", description: "テンソル積（多重線形代数学I（3-11）の結果）を用いた反変・共変・混合テンソル束の定義と例" },
                    ...
                    },
                    {
                        ...
                        sections: [
                            ...
                            { id: "6.5", title: "ストークスの定理", description: "一般ストークスの定理の証明、ベクトル解析（3-1）で扱ったグリーン・ガウス・ストークスの古典的定理の統一としての位置づけ" }
                        ]
                    },
                    {
