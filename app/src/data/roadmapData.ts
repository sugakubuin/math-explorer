        ...
        topics: [
            {
                ...
                chapters: [
                    ...
                    {
                        id: "2", title: "バナッハ空間", description: "完備性、主要な例、縮小写像定理",
                        sections: [
                            ...
                            { id: "2.4", title: "バナッハの不動点定理", description: "縮小写像定理の証明と微分方程式への応用" }
                        ]
                    },
                    {
                    ...
                    },
                    {
                        ...
                        sections: [
                            ...
                            { id: "6.4", title: "直交性と直交補空間", description: "直交の定義と直交補空間の性質" }
                        ]
                    },
                    {
                        ...
                        sections: [
                            ...
                            { id: "7.2", title: "直交射影と直和分解", description: "閉部分空間による直和分解 H = M ⊕ M⊥" },
                    ...
                    {
                        id: "10", title: "スペクトル理論", description: "スペクトルとレゾルベント、有界自己共役作用素のスペクトル定理",
                        sections: [
                            ...
                            { id: "10.5", title: "非有界作用素への展望", description: "本質的自己共役性と量子力学への接続" }
                        ]
                    }
                ],
            ...
            },
            {
                ...
                chapters: [
                    ...
                    {
                        id: "5", title: "双曲幾何とシュワルツ-ピック補題", description: "双曲計量、等長写像、双曲幾何の基礎",
                        sections: [
                            ...
                            { id: "5.4", title: "双曲幾何の基礎", description: "測地線・双曲距離と曲率 -1 の意味" }
                        ]
                    },
                    {
            ...
            },
            {
                ...
                chapters: [
                    ...
                    {
                        id: "5", title: "楕円曲線のパラメトライゼーション", description: "℘ 関数による楕円曲線の一意化・群法則との整合性・同型分類",
                        sections: [
                            ...
                            { id: "5.3", title: "群法則の解析的記述", description: "ℂ/Λ の加法群構造と楕円曲線の3点共線条件による群法則の一致、第1章アーベルの定理との接続" },
                    ...
                    },
                    {
                        ...
                        sections: [
                            ...
                            { id: "7.4", title: "応用例", description: "振り子の正確な周期의 計算、楕円関数による非線形常微分方程式の求積" }
                        ]
                    },
                    {
