    ...
    return (
        <section className="prose prose-slate dark:prose-invert max-w-none text-slate-800 dark:text-slate-200">
            ...
            <ContentBox type="proof" title="Proof">
                <p>
                    この定理の厳密な証明は「バナッハの不動点定理（縮小写像の原理）」を用いるのが現代的で標準的な手法である。以下にその証明を与える。
                </p>
                <p className="mt-4 text-slate-700 dark:text-slate-300 font-bold">[Step 1: 条件の単純化]</p>
                <p className="mt-2">
            ...
            <ContentBox type="remark" title="証明のアプローチについて">
                <p>
                    逆写像定理の証明には、上述の「縮小写像の原理」を用いる方法が一般的です。この方法は非常に強力で、後述するように陰関数定理や、さらには無限次元空間（バナッハ空間）上の微分方程式の解の存在定理などにも直接応用できます。
                </p>
                <p className="mt-2">
                    本質的なアイデアは、非線形な方程式を解く問題を、「アフィン写像（1次近似）で解いた結果に小さな補正を加える」という反復計算プロセス（不動点問題）に落とし込むことです。ヤコビアンが非零であるという線形的な条件が、この反復が必ず真の解に収束すること（縮小性）を保証してくれています。
                </p>
            </ContentBox>
