    ...
    return (
        <section className="prose prose-slate dark:prose-invert max-w-none text-slate-800 dark:text-slate-200">
            ...
            <ContentBox type="remark" title="本コースの締めくくり">
                <p>
                    本コース（3-6 変分法）では、オイラー＝ラグランジュ方程式の導出に始まり、ハミルトン形式、ノーターの定理、そしてこの多変数への接続と、変分学の主要な山脈を縦走してきました。
                    ここから先は、より厳密な <b>4-1 関数解析</b> や、具体的な物理現象を解き明かす <b>5-2 偏微分方程式</b> のコースで、さらに深い理論が展開されます。
